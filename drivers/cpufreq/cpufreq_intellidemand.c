...
#define DEF_STEP_UP_EARLY_HISPEED		(533333)
#define DEF_STEP_UP_INTERIM_HISPEED		(998000)
...
#define SUP_SLOW_UP_FREQUENCY			(800000)
...
static int two_phase_freq_array[NR_CPUS] = {[0 ... NR_CPUS-1] = CONFIG_CPU_FREQ_GOV_INTELLIDEMAND_2_PHASE} ;
